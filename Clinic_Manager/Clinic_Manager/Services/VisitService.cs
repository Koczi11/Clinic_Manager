...
public class VisitService : IVisitService
{
    ...
    public async Task<VisitDto> CreateAsync(CreateVisitDto dto)
    {
        ...
        {
            _logger.LogError(ex, "Błąd podczas tworzenia wizyty dla pacjenta {PatientId}.", dto.PatientId);
            throw;
        }
    }
    ...
    public async Task<bool> UpdateStatusAsync(int id, VisitStatus status)
    {
        ...
        {
            _logger.LogError(ex, "Błąd podczas zmiany statusu wizyty o Id {VisitId} na {Status}.", id, status);
            throw;
        }
    }
    ...
    public async Task<ClinicalNoteDto> AddClinicalNoteAsync(int visitId, CreateClinicalNoteDto dto, string authorName)
    {
        ...
        {
            _logger.LogError(ex, "Błąd podczas dodawania notatki klinicznej do wizyty o ID {VisitId}.", visitId);
            throw;
        }
    }
    ...
    public async Task<ProcedurePerformedDto> AddProcedurePerformedAsync(int visitId, int procedureId)
    {
        ...
        {
            _logger.LogError(ex, "Błąd podczas dodawania wykonanej procedury o ID {ProcedureId} do wizyty o ID {VisitId}.", procedureId, visitId);
            throw;
        }
    }
    ...
    public async Task<PrescribedMedicationDto> AddPrescribedMedicationAsync(int visitId, CreatePrescribedMedicationDto dto)
    {
        ...
        {
            _logger.LogError(ex, "Błąd podczas przepisywania leku o ID {MedicationId} do wizyty o ID {VisitId}.", dto.MedicationId, visitId);
            throw;
        }
    }
}
